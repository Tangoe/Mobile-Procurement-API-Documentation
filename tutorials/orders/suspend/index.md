...
For a SUSPEND order, this JSON typically includes the following pieces:

* Transaction type (i.e., SUSPEND).
* Service ID of the service asset to be suspended.
* Account Holder Company ID (or Account Holder ID) for the user to whom the asset is assigned.
* The properties that are required for suspending a service asset for the specific vendor.
