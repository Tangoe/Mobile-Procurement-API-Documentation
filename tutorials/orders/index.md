...
| ----------------------------------------------		| --------------------- | ------------------------------------------------------------------------------------------- |
| [PORT_NUMBER](/tutorials/orders/PORT_NUMBER/) 		| Procurement 			| Port a  service asset from one carrier to another. 											|
| ----------------------------------------------		| --------------------- | ------------------------------------------------------------------------------------------- |
| [SUSPEND](/tutorials/orders/SUSPEND/)	 				| Care 					| Suspend an active cellular service asset.													|
| ----------------------------------------------		| --------------------- | ------------------------------------------------------------------------------------------- |
| [UNSUSPEND](/tutorials/orders/UNSUSPEND/) 	 		| Care 					| Reactivate a cellular service asset that was previously suspended. 							|
| ----------------------------------------------		| --------------------- | ------------------------------------------------------------------------------------------- |
| [DEACTIVATE](/tutorials/orders/DEACTIVATE/) 	 		| Care 					| Deactivate an active cellular service asset.													|
| ----------------------------------------------		| --------------------- | ------------------------------------------------------------------------------------------- |
| [UPDATE_FEATURES](/tutorials/orders/UPDATE_FEATURES/)	| Care 					| Add or remove optional features on a cellular service asset. 								|
| ----------------------------------------------		| --------------------- | ------------------------------------------------------------------------------------------- |
| [SWAP_DEVICES](/tutorials/orders/SWAP_DEVICES/) 		| Care 					| Reassign cellular service from one device to another. 									|
| ----------------------------------------------		| --------------------- | ------------------------------------------------------------------------------------------- |
...
Please refer to the [Request Headers](/concepts/headers/) page for details regarding what headers are available and how to configure them.
