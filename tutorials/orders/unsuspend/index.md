...
For an UNSUSPEND, this JSON typically includes the following pieces:

* Transaction type (i.e., UNSUSPEND).
* Service ID of the suspended service asset to be reactivated.
* Account Holder Company ID (or Account Holder ID) for the user to whom the asset is assigned.
* The properties that are required for reactivating a suspended service asset for the specific vendor.
...
```
{
  "order": {
    "_meta": {
      "href": "https://tg-mobility.cloudhub.io/mobility/v1/orders/8054742"
    },
    "accountHolder": {
      "companyEmployeeId": "mike.mcpadden.xx1",
      "department": {
    ...
    "dateSubmitted": "2015-12-16T19:27:59Z",
    "externalOrderNumber": "AZ99087547-001",
    "orderId": "8054742",
    "properties": [
      {
